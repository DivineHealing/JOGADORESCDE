...
class Conjunto(models.Model):
    ...
    vida = models.DecimalField(max_digits=5, decimal_places=2, default=0.0, blank=True)
    ...
    # STATUS
    forca = models.DecimalField(default=0, blank=True)
    destreza = models.DecimalField(default=0, blank=True)
    inteligencia = models.DecimalField(default=0, blank=True)
    determinacao = models.DecimalField(default=0, blank=True)
    perspicacia = models.DecimalField(default=0, blank=True)
    carisma = models.DecimalField(default=0, blank=True)
