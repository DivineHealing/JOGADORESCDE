...
class Maestria(models.Model):
    ...
    resistencia_1 = models.DecimalField(max_digits=5, decimal_places=2, default=0, blank=True)
    resistencia_2 = models.DecimalField(max_digits=5, decimal_places=2, default=0, blank=True)
    resistencia_3 = models.DecimalField(max_digits=5, decimal_places=2, default=0, blank=True)
    resistencia_4 = models.DecimalField(max_digits=5, decimal_places=2, default=0, blank=True)
    resistencia_5 = models.DecimalField(max_digits=5, decimal_places=2, default=0, blank=True)
    resistencia_6 = models.DecimalField(max_digits=5, decimal_places=2, default=0, blank=True)
    resistencia_7 = models.DecimalField(max_digits=5, decimal_places=2, default=0, blank=True)
    ...
    penetracao_1 = models.DecimalField(max_digits=5, decimal_places=2, default=0, blank=True)
    penetracao_2 = models.DecimalField(max_digits=5, decimal_places=2, default=0, blank=True)
    penetracao_3 = models.DecimalField(max_digits=5, decimal_places=2, default=0, blank=True)
    penetracao_4 = models.DecimalField(max_digits=5, decimal_places=2, default=0, blank=True)
    penetracao_5 = models.DecimalField(max_digits=5, decimal_places=2, default=0, blank=True)
    penetracao_6 = models.DecimalField(max_digits=5, decimal_places=2, default=0, blank=True)
    penetracao_7 = models.DecimalField(max_digits=5, decimal_places=2, default=0, blank=True)
    ...
    amplificacao_1 = models.DecimalField(max_digits=5, decimal_places=2, default=0, blank=True)
    amplificacao_2 = models.DecimalField(max_digits=5, decimal_places=2, default=0, blank=True)
    amplificacao_3 = models.DecimalField(max_digits=5, decimal_places=2, default=0, blank=True)
    amplificacao_4 = models.DecimalField(max_digits=5, decimal_places=2, default=0, blank=True)
    amplificacao_5 = models.DecimalField(max_digits=5, decimal_places=2, default=0, blank=True)
    #def __str__(self):
